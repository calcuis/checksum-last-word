...
while True:
    ...
    #check if 12, 15, 18, 21 or 24-word seed phrase combination as input; if not, break/quit
    if len(seed_phrase) not in [12, 15, 18, 21, 24]:
        print("Input seed phrase must be 12, 15, 18, 21, or 24 words in length (including ? mark)")
        break
    ...
    #refer to SHA256 library (hashlib) for entropy checksum
